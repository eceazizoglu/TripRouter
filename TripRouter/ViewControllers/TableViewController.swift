...
class TableViewController: UITableViewController {
    ...
    let preferenceDataSource = PreferenceDataSource()
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return preferenceDataSource.preferenceArray.count
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.PreferenceLabel.text = preferenceDataSource.preferenceArray[indexPath.row].name
        cell.PreferenceLabel.textAlignment = NSTextAlignment.center
